<input type="image" src="images/tp-pencil.png" class="tool-icon" id="edit-button" value="Edit" title="<?php echo \tpp\lang('edit_all_tip'); ?>">

<input type="image" src="images/rename.png" class="tool-icon restrict" id="rename-button" value="Rename" title="<?php echo \tpp\lang('rename_tip'); ?>">
